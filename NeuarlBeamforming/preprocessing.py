...
def preprocessing_task1(args):
    ...
    predictors_test, target_test = process_folder('L3DAS22_Task1_test', args)
    ...
    predictors_test_uncut, target_test_uncut = process_folder('L3DAS22_Task1_test', args)
    print ('Saving files')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_set', type=str, default='both',
