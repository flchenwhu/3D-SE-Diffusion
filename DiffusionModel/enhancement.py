...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_dir", type=str, default='dev', help='Directory containing the test data (must have subdirectory noisy/)')
    parser.add_argument("--enhanced_dir", type=str, default='enhance', help='Directory containing the enhanced data')
    parser.add_argument("--ckpt", type=str, default='logs/1/epoch=25-si_sdr=33.09.ckpt'  ,help='Path to model checkpoint.')
    ...
    parser.add_argument("--N", type=int, default=9, help="Number of reverse steps")
